...
public class VehicleUpdate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView lblUpdatedVehicle = (TextView)findViewById(R.id.lblUpdatedVehicle);
        ...
        Manufacturer vehicleId = (Manufacturer) bundle.get("updatedVeh");

        lblUpdatedVehicle.setText("ID: " + vehicleId.getVehicleID() + "\nEngine: " + vehicleId.getEngineType() + "\nDoors: " + vehicleId.getDoorType());
    }
